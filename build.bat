@echo off
title gift rapping simulator - Build Screen
...
:BuildGame 
cls
title gift rapping simulator - Building
...
:BuildDebug
cls
title gift rapping simulator - Building Debug
...
:CancelGame 
cls
title gift rapping simulator - Cancelling
echo Build aborted. Press any key to continue.
exit 

:Credits
cls
title gift rapping simulator - Credits
echo gift rapping simulator
echo.
echo Dev links:
